...
2.  Use PAMpal to generate acoustic studies from all training data
    ...
    2.  Consider removing click detections based on received level, bw_3dB or bw_10dB, duration
3.  Train and evaluate banter models at detection and event levels
