...
#Kogia spp
db_Ksp <- 'H:/Odontocetes/NBHF/Databases/PG2_02_09_CCES_022_Ksp.sqlite3'
binFolder_Ksp <- 'H:/Odontocetes/NBHF/Binaries/PG2_02_09_CCES_022_Ksp'
...
# 
# PdBangarang <- loadTemplateFolder(binFolder_Pd_Bangarang, names=templateNames, extraCols=extraCols, file='H:/Odontocetes/NBHF/MTC/Bangarang.rds')
# 
# PdPascal <- loadTemplateFolder(binFolder_Pd_PASCAL, names=templateNames, extraCols=extraCols, file='H:/Odontocetes/NBHF/MTC/PdPascal.rds')
# 
...
# 
# PpOPPS_008<-loadTemplateFolder(binFolder_Pp_OPPS_008, names=templateNames, extraCols=extraCols, file='H:/Odontocetes/NBHF/MTC/OPPS_008_Template.rds')
# 
...
PdCalcurseas<-readRDS(here('data','MTC','CalCurseas_Dalls_Template.rds'))
PdBangarang<-readRDS(here('data','MTC','Bangarang.rds'))
PdPascal<-readRDS(here('data','MTC','PdPascal.rds'))
PpCalcurseas<-readRDS(here('data','MTC','CalCurseas_Harbor_Template.rds'))
PpOPPS_010<-readRDS(here('data','MTC','OPPS_010_Template.rds'))
PpOPPS_008<-readRDS(here('data','MTC','OPPS_008_Template.rds'))
Ksp_CCES_022<-readRDS(here('data','MTC','CCES_022_Template.rds'))
